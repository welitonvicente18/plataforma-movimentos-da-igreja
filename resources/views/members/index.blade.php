        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="flex flex-row gap-4 p-2">
                    ...
                    <div class="p-2 w-100 flex-2 text-gray-900 dark:text-gray-100 text-right ">
            ...
            <form action="{{ route('members.index') }}" method="GET">
                ...
                <div class="p-3 flex flex-row gap-4 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                    ...
                    <div class="flex flex-row text-center p-4">
                        <x-gray-button type="submit" class=" ms-3">
                            Pesquisar
                        </x-gray-button>
                            ...
                            <td class="px-2 py-2 text-left">
                                ...
                                <div class="w-2/12">
                                    <x-img
                                        ...
                                        width="70px" height="100px" class="rounded-lg" accept="jpeg,png,jpg"/>
                                </div>
                                <div class="w-10/12 px-2 py-2 align-center">
